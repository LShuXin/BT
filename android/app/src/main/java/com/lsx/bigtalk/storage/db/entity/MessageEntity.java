    ...
    public String getMessageDisplay() {
        switch (displayType) {
            case AppConstant.DBConstant.SHOW_TYPE_AUDIO:
                return AppConstant.DBConstant.DISPLAY_FOR_AUDIO;
            case AppConstant.DBConstant.SHOW_TYPE_PLAIN_TEXT:
                return content;
            case AppConstant.DBConstant.SHOW_TYPE_IMAGE:
                return AppConstant.DBConstant.DISPLAY_FOR_IMAGE;
            case AppConstant.DBConstant.SHOW_TYPE_RICH_TEXT:
                return AppConstant.DBConstant.DISPLAY_FOR_RICH_TEXT;
            default:
                return AppConstant.DBConstant.DISPLAY_FOR_ERROR;
        }
    }
