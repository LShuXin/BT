...
@interface BTDataInputStream(PrivateMethods)
-(int32_t)read;
@end


@implementation BTDataInputStream
...
{
    BTDataInputStream *dataInputStream = [[self alloc] initWithData:aData];
    return dataInputStream ;
}

-(NSUInteger)getAvailableLen
{
    return [data length];
}
