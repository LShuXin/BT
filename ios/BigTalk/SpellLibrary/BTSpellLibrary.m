...
{
    static BTSpellLibrary* g_spellLibrary;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        g_spellLibrary = [[BTSpellLibrary alloc] init];
    });
...
- (void)addDeparmentSpellForObject:(id)sender
{
    ...
    {
        word = [(BTUserEntity*)sender department];
    }
    else
    {
        return;
...
- (void)addSpellForObject:(id)sender
{
    ...
    if ([sender isKindOfClass:[BTUserEntity class]])
    {
        word = [(BTUserEntity*)sender nick];
    }
    else if ([sender isKindOfClass:[BTGroupEntity class]])
    {
        word = [(BTGroupEntity*)sender name];
    }
    else
    {
        return;
