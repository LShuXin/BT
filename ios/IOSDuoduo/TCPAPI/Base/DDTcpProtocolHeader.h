...
static const int16_t MODULE_ID_REMOTEBASE = 0x0000U; // 与服务器端交互的 module id
static const int16_t MODULE_ID_LOCALBASE = 0x4000U;  // 本地业务的 module id
...
enum
{
    ...
    DEPARTINFO_REQ                  =   0x0210,     // 部门信息请求
    DEPARTINFO_RES                  =   0x0211      // 部门信息返回
};
...
//    MODULE_ID_GROUP             = MODULE_ID_REMOTEBASE | 0x0052,    // group module
    ...
    MODULE_ID_COMMON            = MODULE_ID_LOCALBASE | 0X0002,      // 多多公共函数库
};
