...
-(void)initData
{
    ...
    [self.avatar sd_setImageWithURL:[NSURL URLWithString:[self.user getAvatarUrl]]
...
-(IBAction)startConversation:(id)sender
{
    SessionEntity* session = [[SessionEntity alloc] initWithSessionID:self.user.objID type:SessionType_SessionTypeSingle];
