...
-(void)viewDidLoad
{
    ...
    self.nv1.tabBarItem.tag = 0;
    [self.nv1.tabBarItem setTitleTextAttributes:[NSDictionary dictionaryWithObject:RGB(26, 140, 242) forKey:UITextAttributeTextColor]
    ...
    [nv2.tabBarItem setTitleTextAttributes:[NSDictionary dictionaryWithObject:RGB(26, 140, 242) forKey:UITextAttributeTextColor]
                                  forState:UIControlStateSelected];
    ...
    [nv3.tabBarItem setTitleTextAttributes:[NSDictionary dictionaryWithObject:RGB(26, 140, 242) forKey:UITextAttributeTextColor]
                                  forState:UIControlStateSelected];
    ...
    [nv4.tabBarItem setTitleTextAttributes:[NSDictionary dictionaryWithObject:RGB(26, 140, 242) forKey:UITextAttributeTextColor]
                                  forState:UIControlStateSelected];
        ...
        if (self.clickCount == 2)
        {
            if ([[[RecentUsersViewController shareInstance].tableView visibleCells] count] > 0)
            {
                [[RecentUsersViewController shareInstance].items enumerateObjectsUsingBlock:^(SessionEntity* obj, NSUInteger idx, BOOL* stop) {
                    ...
                    {
                        [[RecentUsersViewController shareInstance].tableView scrollToRowAtIndexPath:[NSIndexPath indexPathForRow:idx inSection:0]
