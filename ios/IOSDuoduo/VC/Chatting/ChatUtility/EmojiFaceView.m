...
#define DD_MAC_EMOTIONS_COUNT_PERPAGE                           19
#define DD_EMOTIONS_PERROW                                      4
#define DD_EMPTIONS_ROWS                                        2
...
{
	//row number
    NSArray* emotions = [[EmotionsModule shareInstance].emotionUnicodeDic allValues];
